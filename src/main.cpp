...
int main(int argc, char *argv[]) {
  ...
  QObject::connect(&w, &CalcView::uiEventSendUi, &c,
                   &s21::CalcController::sendCalcViewUi);
  // CONNECT GRAPH
  Graph g;
  ...
  QObject::connect(&w, &CalcView::uiEventSendResult, &g, &Graph::sendResult);
  QObject::connect(&g, &Graph::uiEventSendUi, &c,
                   &s21::CalcController::sendGraphUi);
  ...
  QObject::connect(&r, &Credit::uiEventSendUi, &c,
                   &s21::CalcController::sendCreditUi);
  ...
  QObject::connect(&t, &Debit::uiEventSendUi, &c,
                   &s21::CalcController::sendDebitUi);
